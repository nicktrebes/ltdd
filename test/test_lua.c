...
static void test_constraint_name(const char *name);
...
Ensure(Lua, open_libs_creates_ltdd_constraint_name) {
	test_function_created("constraint_name");
}
...
Ensure(Lua, constraint_name_returns_name_for_is_equal_to) {
	test_constraint_name("is_equal_to");
}

Ensure(Lua, constraint_name_returns_name_for_is_not_equal_to) {
	test_constraint_name("is_not_equal_to");
}

Ensure(Lua, constraint_name_returns_name_for_is_nil) {
	test_constraint_name("is_nil");
}

Ensure(Lua, constraint_name_returns_name_for_is_not_nil) {
	test_constraint_name("is_not_nil");
}

Ensure(Lua, constraint_name_returns_name_for_is_greater_than) {
	test_constraint_name("is_greater_than");
}

Ensure(Lua, constraint_name_returns_name_for_is_less_than) {
	test_constraint_name("is_less_than");
}

Ensure(Lua, constraint_name_returns_name_for_is_false) {
	test_constraint_name("is_false");
}

Ensure(Lua, constraint_name_returns_name_for_is_true) {
	test_constraint_name("is_true");
}

Ensure(Lua, is_equal_to_returns_true_if_equal) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
...
Ensure(Lua, is_equal_to_returns_false_if_not_equal) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
	lua_getfield(L, -1, "is_equal_to");
	lua_pushinteger(L, 0);
...
Ensure(Lua, is_not_equal_to_returns_true_if_not_equal) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
...
Ensure(Lua, is_not_equal_to_returns_false_if_equal) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
	lua_getfield(L, -1, "is_not_equal_to");
	lua_pushinteger(L, 1);
...
Ensure(Lua, is_nil_returns_true_if_nil) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
...
Ensure(Lua, is_nil_returns_false_if_not_nil) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
	lua_getfield(L, -1, "is_nil");
	lua_pushinteger(L, 1);
...
Ensure(Lua, is_not_nil_returns_true_if_not_nil) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
...
Ensure(Lua, is_not_nil_returns_false_if_nil) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
	lua_getfield(L, -1, "is_not_nil");
	lua_pushnil(L);
...
Ensure(Lua, is_false_returns_true_if_false) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
...
Ensure(Lua, is_false_returns_false_if_true) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
	lua_getfield(L, -1, "is_false");
	lua_pushboolean(L, 1);
...
Ensure(Lua, is_true_returns_true_if_true) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
...
Ensure(Lua, is_true_returns_false_if_false) {
	lua_State *L = ltdd_lua_open_libs();
	lua_getglobal(L, "ltdd");
	lua_getfield(L, -1, "is_true");
	lua_pushboolean(L, 0);
...
TestSuite *test_lua(void) {
	...
	add_test_with_context(suite, Lua, open_libs_creates_ltdd_constraint_name);
	...
	add_test_with_context(suite, Lua, constraint_name_returns_name_for_is_equal_to);
	add_test_with_context(suite, Lua, constraint_name_returns_name_for_is_not_equal_to);
	add_test_with_context(suite, Lua, constraint_name_returns_name_for_is_greater_than);
	add_test_with_context(suite, Lua, constraint_name_returns_name_for_is_less_than);
	add_test_with_context(suite, Lua, constraint_name_returns_name_for_is_nil);
	add_test_with_context(suite, Lua, constraint_name_returns_name_for_is_not_nil);
	add_test_with_context(suite, Lua, constraint_name_returns_name_for_is_false);
	add_test_with_context(suite, Lua, constraint_name_returns_name_for_is_true);
	add_test_with_context(suite, Lua, is_equal_to_returns_true_if_equal);
	add_test_with_context(suite, Lua, is_equal_to_returns_false_if_not_equal);
	add_test_with_context(suite, Lua, is_not_equal_to_returns_true_if_not_equal);
	add_test_with_context(suite, Lua, is_not_equal_to_returns_false_if_equal);
	add_test_with_context(suite, Lua, is_nil_returns_true_if_nil);
	add_test_with_context(suite, Lua, is_nil_returns_false_if_not_nil);
	add_test_with_context(suite, Lua, is_not_nil_returns_true_if_not_nil);
	add_test_with_context(suite, Lua, is_not_nil_returns_false_if_nil);
	add_test_with_context(suite, Lua, is_false_returns_true_if_false);
	add_test_with_context(suite, Lua, is_false_returns_false_if_true);
	add_test_with_context(suite, Lua, is_true_returns_true_if_true);
	add_test_with_context(suite, Lua, is_true_returns_false_if_false);
...
static void test_constraint_name(const char *name) {
	...
	lua_pcall(L, 1, 1, 0);
	assert_that(lua_tostring(L, -1), is_equal_to_string(name));
	lua_close(L);
}
